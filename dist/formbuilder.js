  ...
  Formbuilder = (function() {
    ...
    Formbuilder.options = {
      ...
      mappings: {
        ...
        REVERT_TIME: 'field_options.revert_time',
        EXPLANATION: 'field_options.explanation',
        CORRECTION: 'field_options.correction',
...
(function() {
  Formbuilder.registerField('questions', {
    order: 3,
    view: "",
    edit: "<%= Formbuilder.templates['edit/video_time']() %>",
    addButton: "<span class=\"symbol\"><span class=\"fa fa-home\"></span></span> Questions"
  });
...
(function() {
  Formbuilder.registerField('checkboxes', {
    ...
    edit: "<%= Formbuilder.templates['edit/options']({ includeOther: true }) %>\n<%= Formbuilder.templates['edit/answer']() %><%= Formbuilder.templates['edit/revert_time']() %><%= Formbuilder.templates['edit/question_explanation']() %>",
...
(function() {
  Formbuilder.registerField('general', {
    order: 40,
    view: "",
    edit: "",
    addButton: "<span class=\"symbol\"><span class=\"fa fa-envelope-o\"></span></span> General"
  });
...
(function() {
  Formbuilder.registerField('info-box', {
    order: 1,
    view: "<textarea class='rf-size-<%= rf.get(Formbuilder.options.mappings.TIME) %>'></textarea>",
    edit: "<%= Formbuilder.templates['edit/video_time']() %>",
    addButton: "<span class=\"symbol\">&#182;</span> Info Box",
    defaultAttributes: function(attrs) {
...
(function() {
  Formbuilder.registerField('text', {
    order: 5,
    view: "<input type='text' class='rf-size-<%= rf.get(Formbuilder.options.mappings.ANSWER) %>' />",
    edit: "<%= Formbuilder.templates['edit/answer']() %><%= Formbuilder.templates['edit/revert_time']() %><%= Formbuilder.templates['edit/question_explanation']() %>",
...
((__t = ( Formbuilder.options.mappings.LABEL )) == null ? '' : __t) +
'\' />\n<textarea class="redactor" data-rv-input=\'model.' +
...
this["Formbuilder"]["templates"]["edit/video_time"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class=\'fb-edit-section-header\'>Time (seconds)</div>\n\n<input class="time-field" type="text" data-rv-input="model.' +
((__t = ( Formbuilder.options.mappings.TIME )) == null ? '' : __t) +
'" style="width: 100px" /><input type="button" onclick="setVideoTime(this)" value="Set Current Time"></input>';
...
this["Formbuilder"]["templates"]["edit/answer"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class=\'fb-edit-section-header\'>Answers (comma delimited)</div>\n<input data-rv-value="model.' +
((__t = ( Formbuilder.options.mappings.ANSWER )) == null ? '' : __t) +
'"/>\n';
...
this["Formbuilder"]["templates"]["edit/revert_time"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class=\'fb-edit-section-header\'>Back to time</div>\n<input data-rv-value="model.' +
((__t = ( Formbuilder.options.mappings.REVERT_TIME )) == null ? '' : __t) +
'"/>\n';
...
this["Formbuilder"]["templates"]["edit/question_explanation"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class=\'fb-edit-section-header\'>Question Explanation/Correction</div>\n<textarea data-rv-input=\'model.' +
((__t = ( Formbuilder.options.mappings.EXPLANATION )) == null ? '' : __t) +
'\'\n  placeholder=\'Question Explanation\' class="redactor"></textarea>\n<textarea data-rv-input=\'model.' +
((__t = ( Formbuilder.options.mappings.CORRECTION )) == null ? '' : __t) +
'\'\n  placeholder=\'Question Correction\' class="redactor"></textarea>';
...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class="element-title">' + capitaliseFirstLetter(rf.get(Formbuilder.options.mappings.FIELD_TYPE)) + '</div><div class=\'subtemplate-wrapper\'>\n  <div class=\'cover\'></div>\n  ' +
